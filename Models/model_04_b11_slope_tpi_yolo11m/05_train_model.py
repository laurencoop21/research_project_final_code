...
# Load a medium pretrained YOLO11 model
...
shutil.copy2(
    best_model,
    checkpoints_dir / "model_04_best.pt",
)

shutil.copy2(
    last_model,
    checkpoints_dir / "model_04_last.pt",
)

print("\nTraining complete.")
print("Best model saved to:")
print(checkpoints_dir / "model_04_best.pt")

print("\nLast model saved to:")
print(checkpoints_dir / "model_04_last.pt")