...
matches_path = reports_dir / "model_17_test_ground_truth_matches.csv"

instance_output = reports_dir / "model_17_test_instance_to_tell.csv"
tell_output = reports_dir / "model_17_unique_tell_detection.csv"
summary_output = reports_dir / "model_17_unique_tell_recall_by_size.csv"
...
# Print results
print("Model 17 unique-tell recall")
print("---------------------------")
