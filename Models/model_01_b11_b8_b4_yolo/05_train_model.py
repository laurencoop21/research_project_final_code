...
model.train(
    ...
    # augmentation for overhead imagery
    degrees=180,
    fliplr=0.5,
    flipud=0.5,
...
shutil.copy2(
    best_model,
    checkpoints_dir / "model_01_best.pt",
)

shutil.copy2(
    last_model,
    checkpoints_dir / "model_01_last.pt",
)

print("\nTraining complete.")
print("Best model saved to:")
print(checkpoints_dir / "model_01_best.pt")

print("\nLast model saved to:")
print(checkpoints_dir / "model_01_last.pt")
