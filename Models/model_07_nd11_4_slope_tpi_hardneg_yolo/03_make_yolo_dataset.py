        ...
        for row_start in row_starts:
            for col_start in col_starts:
                ...
                for _, tell in intersecting_tells.iterrows():
                    ...
                    #
                    # If a tile contains only these partial tells, exclude
                    # the tile below rather than treating it as background.
                ...
                # Exclude ambiguous hidden-positive tiles:
                # a known tell intersects the tile, but no tell is at
                # least 50% visible and therefore no label was created.
                if not intersecting_tells.empty and not labels:
                    continue
