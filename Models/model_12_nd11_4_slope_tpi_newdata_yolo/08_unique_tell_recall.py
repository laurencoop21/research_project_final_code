...
matches_path = reports_dir / "model_12_test_ground_truth_matches.csv"

instance_output = reports_dir / "model_12_test_instance_to_tell.csv"
tell_output = reports_dir / "model_12_unique_tell_detection.csv"
summary_output = reports_dir / "model_12_unique_tell_recall_by_size.csv"
...
# Print results
print("Model 12 unique-tell recall")
print("---------------------------")
