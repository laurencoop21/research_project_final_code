...
results = model.val(
    ...
    name="model_02_test_evaluation",
)

# Save the test metrics
metrics = {
    "model": "Model 2: B11-B8-B4 YOLO with 256-pixel tiles",
...
print("\nSaved test plots to:")
print(runs_dir / "model_02_test_evaluation")