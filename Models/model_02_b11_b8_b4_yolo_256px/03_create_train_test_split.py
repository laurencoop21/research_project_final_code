...
# IMPORTANT
# This split was originally created for Model 1.
# Model 2 reuses the Model 1 geographic split so that
# tile size is the only experimental difference.
#
# Do not run this script for Model 2 because it will
# overwrite reports/geographic_split.gpkg.
